...
import "dart:async";
import "main12.dart"; //for current user
...
//      print("postId Length" + doc.data.toString());
      setState(() {
        print("insta_comments" + doc['timestamp']);
        items.add(Comment(doc['username'],doc['userId'] , doc['avatarUrl'],doc['comment'] ,doc['timestamp'] ));
        print("postId Length" + items.length.toString());
