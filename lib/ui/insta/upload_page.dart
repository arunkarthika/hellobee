...
class Uploader1 extends StatefulWidget {
  Uploader1({Key key, @required this.tosearch})
      : super(key: key);

  final File tosearch;

  Uploader createState() =>
      Uploader(file: tosearch);

}

class Uploader extends State<Uploader1> {
  Uploader(
